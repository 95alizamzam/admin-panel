...
class OneUserModel {
  ...
  */
  ...
  OneUserModel.fromMap(Map<String, dynamic> userInfo, String uId) {
...
class OnePersonModel extends OneUserModel {
  String? gender;
  String? dateBirth;
  ...
  OnePersonModel.fromMap(Map<String, dynamic> userInfo, String uId)
...
class OneCompanyModel extends OneUserModel {
  ...
  OneCompanyModel.fromMap(Map<String, dynamic> userInfo, String uId)
      : super.fromMap(userInfo, uId) {
