...
import 'package:marketing_admin_panel/UI/offers_tab/tabs/video_offers.dart';
import 'package:marketing_admin_panel/models/offers_model.dart';
import 'owner_row.dart';

class VideoDetailsScreen extends StatelessWidget {
  const VideoDetailsScreen({Key? key, required this.navigator, required this.video}) : super(key: key);
      ...
      body: ListView(
        children: [
          ...
          LikesAndComments(
            ...
            offerOwnerType: video.offerOwnerType!,
            offerId: video.id!,
            offerType: video.offerType!,
          ),
        ],
      ),
    );
